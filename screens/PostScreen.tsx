                    ...
                    return (
                        ...
                        <View key={index} style={{ flexDirection: 'row', marginLeft: 5, marginTop:10  }}>
                            ...
                            <View >
                              ...
                              {item.like ? <FontAwesome style={{ marginHorizontal: 15 , marginTop: 7, color:'red'}} name='heart' size={23} /> : <Feather style={{ marginHorizontal: 15 , marginTop: 7}} name='heart' size={23} />}
